    ...
    for (p = 0; p < numPlayer; p++) {
      if(p == 0) {
        ...
        ****************************************************************************************/
        ...
        checker = mineCase(mine, silver, &Gtest, maxHandCount-1, p);
        ...
        ****************************************************************************************/
        ...
        checker = mineCase(copper, mine, &Gtest, maxHandCount-1, p);
        ...
        ****************************************************************************************/
        ...
        checker = mineCase(copper, gold, &Gtest, maxHandCount-1, p);
        ...
        ****************************************************************************************/
        ...
        checker = mineCase(maxHandCount-2, silver, &Gtest, maxHandCount-1, p);
